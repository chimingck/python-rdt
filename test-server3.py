...
def main():
	...
	if len(sys.argv) != 5:
		print("Usage:  "+sys.argv[0]+"  <client IP>  <drop rate>  <error rate>  <Window size>")
		sys.exit(0)

	MSG_LEN = rdt.PAYLOAD * int(sys.argv[4])	#define the max message length
	...
	rdt.rdt_network_init(sys.argv[2], sys.argv[3], sys.argv[4])
